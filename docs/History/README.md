...
| [dashboard-spec.md](dashboard-spec.md) | **SUPERSEDED** | The pre-Supabase app: hardcoded data, dummy GPS, dead search bar, and a Quiz tab that no longer exists | [Features/Swipe-Deck.md](../Features/Swipe-Deck.md), [Features/Likes-Visits.md](../Features/Likes-Visits.md) |
